...
/* 
 * Display Title of the webpage as replacement for a logo in META 
 *  (uses another id for the arialabel, cause we dont want do duplicate it)
 * 
...
echo '<span class="textlogo">';
	...
	echo fau_use_svg("fau-logo-2021",153,58,'faubaselogo',false, ['hidden' => true, 'labelledby' => 'website-title-meta','role' => 'img']); 
	echo '</span>';	
    ...
    if ($visible_title) {
	echo '<span id="website-title-meta" class="visible-title';
	if (!empty($faculty)) {
	    echo ' '.$faculty;
	}
